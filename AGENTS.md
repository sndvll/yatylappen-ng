...
- **@ngrx/signals** (migrerar från @ngrx/store + @ngrx/effects)
- **Angular Material** CDK
- **@ngx-translate/core** för i18n
- **@fortawesome/angular-fontawesome** för ikoner
...
- **State**: Centraliserad via signalStore. Inga privata state-klasser
